...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="adminPhoto.php">Photo <span class="sr-only">(current)</span></a>
            </li>
        </ul>
	      ...
	      <div class="modal-body">
	        <form action="adminTable.php" method="post">
	        	<div class="form-group">
	        		<input type="text" class="form-control" name="nameAlbum" value="" placeholder="nameAlbum">
	        	</div>
	        	<div class="form-group">
	        		<input type="date" class="form-control" name="dateRelise" value="" placeholder="dateRelise">
	        	</div>
	      </div>
